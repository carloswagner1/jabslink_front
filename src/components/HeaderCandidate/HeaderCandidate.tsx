      ...
      <Container>
        ...
        <Navbar.Collapse id="responsive-navbar-nav ">
          <Nav fill className="me-auto" variant="tabs" defaultActiveKey="/home">
            <Nav.Item>
              <Link className="nav-link active" aria-current="page" to="/candidate">
                <svg
            ...
            <Nav.Item>
              <Link className="nav-link" to="myvacancies">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                  fill="currentColor"
                  className="bi bi-clipboard me-2 mb-1"
                  viewBox="0 0 16 16"
                >
            ...
            <Nav.Item>
              <Link className="nav-link" to="opportunities">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-newspaper me-2 mb-1"
                  viewBox="0 0 16 16"
                >
          ...
          <Nav>
            ...
            >
              ...
              <NavDropdown.Item>
              <Link className="text-black" style={{ textDecoration: 'none' }} to={"./password"}>Alterar senha</Link> 
              </NavDropdown.Item>
              <NavDropdown.Divider />
